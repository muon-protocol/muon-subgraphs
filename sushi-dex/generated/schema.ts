...
export class SushiFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save SushiFactory entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save SushiFactory entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("SushiFactory", id.toString(), this);
    }
  }

  static load(id: string): SushiFactory | null {
    return changetype<SushiFactory | null>(store.get("SushiFactory", id));
  }
