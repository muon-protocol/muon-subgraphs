...
import { Pair, SpookySwapFactory, Swap as SwapEvent, Token, Transaction } from "../generated/schema"
...
export function handlePairCreated(event: PairCreated): void {
  ...
  let factory = SpookySwapFactory.load(FACTORY_ADDRESS)
  if (factory === null) {
    factory = new SpookySwapFactory(FACTORY_ADDRESS)
    factory.pairCount = 0
  }
