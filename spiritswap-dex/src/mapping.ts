...
import { Pair, SpiritSwapFactory, Swap as SwapEvent, Token, Transaction } from "../generated/schema"
...
export function handlePairCreated(event: PairCreated): void {
  ...
  let factory = SpiritSwapFactory.load(FACTORY_ADDRESS)
  if (factory === null) {
    factory = new SpiritSwapFactory(FACTORY_ADDRESS)
    factory.pairCount = 0
  }
