...
export class MRC1155Bridge__getTxResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MRC1155Bridge__txsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
...
export class MRC1155Bridge extends ethereum.SmartContract {
  static bind(address: Address): MRC1155Bridge {
    return new MRC1155Bridge("MRC1155Bridge", address);
  }
  ...
  getTx(_txId: BigInt): MRC1155Bridge__getTxResult {
    let result = super.call(
      "getTx",
      "getTx(uint256):(uint256,uint256,uint256,uint256,address,address,uint256[],uint256[])",
      [ethereum.Value.fromUnsignedBigInt(_txId)]
    );

    return new MRC1155Bridge__getTxResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getTx(_txId: BigInt): ethereum.CallResult<MRC1155Bridge__getTxResult> {
    let result = super.tryCall(
      "getTx",
      "getTx(uint256):(uint256,uint256,uint256,uint256,address,address,uint256[],uint256[])",
      [ethereum.Value.fromUnsignedBigInt(_txId)]
    ...
    return ethereum.CallResult.fromValue(
      new MRC1155Bridge__getTxResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  txs(param0: BigInt): MRC1155Bridge__txsResult {
    let result = super.call("txs", "txs(uint256):(uint256,uint256,address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new MRC1155Bridge__txsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress()
    );
  ...
  try_txs(param0: BigInt): ethereum.CallResult<MRC1155Bridge__txsResult> {
    let result = super.tryCall(
      "txs",
...
export class EmergencyWithdrawERC1155TokensCall extends ethereum.Call {
  get inputs(): EmergencyWithdrawERC1155TokensCall__Inputs {
    return new EmergencyWithdrawERC1155TokensCall__Inputs(this);
  }

  get outputs(): EmergencyWithdrawERC1155TokensCall__Outputs {
    return new EmergencyWithdrawERC1155TokensCall__Outputs(this);
  }
}

export class EmergencyWithdrawERC1155TokensCall__Inputs {
  _call: EmergencyWithdrawERC1155TokensCall;

  constructor(call: EmergencyWithdrawERC1155TokensCall) {
    this._call = call;
  }
...
export class EmergencyWithdrawERC1155TokensCall__Outputs {
  _call: EmergencyWithdrawERC1155TokensCall;
